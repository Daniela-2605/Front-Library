<template>
  ...
  <form @submit.prevent="addBook">
    <div style="display: flex; flex-direction: column; width: 300px; justify-content: space-around; align-items: baseline;">
      ...
      <input style="margin-bottom: 10px" v-model.number="form.añoPublicacion" type="number" placeholder="Año" required />
